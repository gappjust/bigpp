...
execute store result score #doInsomnia n run gamerule doInsomnia
execute unless score #skipping_night n matches 1 if score #resting_players n >= #required_sleeping_players n if score #overworld_players n matches 2.. run gamerule doInsomnia false
execute unless score #skipping_night n matches 1 if score #resting_players n >= #required_sleeping_players n if score #overworld_players n matches 2.. if score #doInsomnia n matches 1 run schedule function server_sleep:enable_phantoms 1d
